_base_ = '/home/borisef/projects/mm/mmdetection/boris3/config/_base_/default_runtime.py'
# dataset settings
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        dataset=dict(
            type=dataset_type,
            #data_root=data_root,
            ann_file='/home/borisef/data/vehicles/train/_annotations.coco.json',
            data_prefix=dict(img='/home/borisef/data/vehicles/train/'),
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_prefix=dict(img='/home/borisef/data/vehicles/test/'),
        test_mode=True,
