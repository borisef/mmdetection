...
work_dir = '/home/borisef/projects/mmdetHack/Runs/traffic_da_gray2_rgb_v01'
model = dict(
    type='FasterRCNN',
    backbone=dict(
        type='ResNet',
...
data = dict(
    ...
    train=dict(
        type='CocoDataset',
        ann_file='set_100_domain_Gray2/data_da.json',
        img_prefix='set_100_domain_Gray2/',
        classes = CLASSES,
        pipeline=train_pipeline,
        data_root='/home/borisef/datasets/traffic/'),
    val=dict(
        type='CocoDataset',
        ann_file='set_50_domain_RGB/data_da.json',
        img_prefix='set_50_domain_RGB/',
        classes = CLASSES,
...
example_images = '/home/borisef/datasets/traffic/set_50_domain_RGB/'
