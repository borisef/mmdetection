...
work_dir = '/home/borisef/projects/mmdetHack/Runs/traffic_withda_mix3instance_domains_v06resnet500_no_da'
model = dict(
    type='FasterRCNN',
    backbone=dict(
        type='ResNet',
    ...
    roi_head=dict(
        ...
        extra_head_params = dict(
            ...
            lambda_params = dict(max_epochs = 100, iters_per_epoch = 20, power_factor = 3.0, default_lambda = None, starting_epoch = 0)
        ),
        ...
        extra_bbox_head=dict(
                    ...
                    fc_out_channels=1024,
                    roi_feat_size=7,
                    num_classes=num_domains-1, # TODO: make -1 behind the scene
                    bbox_coder=dict(
                        type='DeltaXYWHBBoxCoder',
                        target_means=[0.0, 0.0, 0.0, 0.0],
                        target_stds=[0.1, 0.1, 0.2, 0.2]),
